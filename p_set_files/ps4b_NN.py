...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        """
        # create empty shift dictionary, lowercase string and uppercase string
        shift_dict = {}
        lower_case = string.ascii_lowercase
        upper_case = string.ascii_uppercase

        # to each letter in the lowercase and uppercase alphabet
        # assign a shifted letter
        # % 26 assured the shifted value is withing the allowed range
        for index in range(len(lower_case)):
            new_index = (shift + index) % 26
            shift_dict[lower_case[index]] = lower_case[new_index]
            shift_dict[upper_case[index]] = upper_case[new_index]
...
class PlaintextMessage(Message):
    ...
    def change_shift(self, shift):
        ...
        if 0 <= shift < 26:
            ...
            print('Shift value must be >= 0 and < 26')
